...
export default function EditAvailabilityModal({ availability, open, onClose, onSuccess }: EditAvailabilityModalProps) {
            ...
            <DialogContent>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    <div className="flex flex-col">
                        ...
                        <Listbox value={fields.day} onChange={d => setFields(f => ({ ...f, day: d }))}>
                                        ...
                                        {DAYS.map((day) => (
                                            <Listbox.Option
                                                ...
                                                className={({ active, selected }) =>
                                                    ...
                                                    ${selected ? 'bg-[#ba55d3] text-white' : ''}
                                                    ${active && !selected ? 'bg-purple-100 text-purple-900' : ''}
                                                    `
                                                }
                                            >
                                                {({ selected }) => (
                    ...
                    <div className="flex flex-col">
                        ...
                        <input
                            ...
                            min={1}
                            value={fields.slots}
                            onChange={e => setFields(f => ({ ...f, slots: e.target.value }))}
                            className="border w-full rounded px-2 py-1"
                            required
                        />
                    </div>
