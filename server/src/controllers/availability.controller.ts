...
export const updateSingleAvailability = asycHandler(async (req, res) => {
    ...
    if (Object.prototype.hasOwnProperty.call(updateFields, 'day')) availability.day = updateFields.day;
    if (Object.prototype.hasOwnProperty.call(updateFields, 'startTime')) availability.startTime = updateFields.startTime;
    if (Object.prototype.hasOwnProperty.call(updateFields, 'endTime')) availability.endTime = updateFields.endTime;
    if (Object.prototype.hasOwnProperty.call(updateFields, 'slots')) availability.slots = parseInt(updateFields.slots);
...
export const createInstructorAvailability = async (req: Request, res: Response) => {
    try {
...
export const deleteSingleAvailability = asycHandler(async (req, res) => {
    const { availabilityID } = req.params;
